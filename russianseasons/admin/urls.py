...
urlpatterns = [
	...
	path('users/update', views.UsersPage.as_view(), name='admin_user_url'),
	...
	path('shop/categories/new', views.NewCategoryPage.as_view(), name='admin_new_category_url'),
	path('shop/categories/<int:id>/edit', views.NewCategoryPage.as_view(), name='admin_edit_category_url'),
	path('shop/categories', views.CategoriesPage.as_view(), name='admin_categories_url'),
	...
	path('shop/item/<int:id>/item_image', views.ItemImage.as_view(), name='admin_item_image_url'),
